...
--(c) then ORDER BY fist_name in ascending order to get the names in alphabetical order from A-Z.
...
--(a) Identify the table which has returned dates in it, i used rental table and then iuse the where clause to get the return dates
